...
const Notifications = () => { 
    ...
    const requestSentBYMe = async () =>{
      try {
          const response = await fetch('http://localhost:5000/requestSentBYMe', { 
              method: 'GET',
          })
    ...
    const getRequest = async () =>{
        try {
            const response = await fetch('http://localhost:5000/getRequest', { 
                method: 'GET',
            })
    ...
    const handleCancelRequest = async (e) =>{
      let personId = e.target.id;
      try {
        const response = await fetch('http://localhost:5000/cancelRequest', {
          method: 'POST',
          headers: {
              'Content-Type' : 'application/json' 
          },
